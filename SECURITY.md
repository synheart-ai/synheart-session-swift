...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-session-swift/security/advisories/new).
...
This policy covers the `SynheartSession` Swift SDK published from this
